...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _translations = {
    'zh': {
      ...
      'favoriteDirectories': '常用目录',
      'addDirectory': '添加目录',
      'removeDirectory': '移除目录',
      'addDirectoryHint': '点击添加常用目录',

      // File list
      'encryptSelected': '加密所选',
      'decryptSelected': '解密所选',
      'selectFilesFirst': '请先选择文件',
      'noFilesInDirectory': '此目录下暂无文件',
      'loadingDirectory': '正在加载...',
      'gridView': '网格视图',
      'listView': '列表视图',
      'breadcrumbHome': '文件浏览',
    ...
    'en': {
      ...
      'addDirectoryHint': 'Add a favorite directory',

      // File list
      'encryptSelected': 'Encrypt Selected',
      'decryptSelected': 'Decrypt Selected',
      'selectFilesFirst': 'Please select files first',
      'noFilesInDirectory': 'No files in this directory',
      'loadingDirectory': 'Loading...',
      'gridView': 'Grid View',
      'listView': 'List View',
      'breadcrumbHome': 'File Browser',
